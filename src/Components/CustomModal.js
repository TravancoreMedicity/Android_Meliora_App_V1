    ...
    <View>
        <Portal>
          <Dialog visible={modalVisible} onDismiss={setModalVisible}>
            <Dialog.Title  style={{ color: "rgb(217,75,155)", fontFamily : 'Roboto_500Medium' }}  >Message</Dialog.Title>
            <Dialog.Content>
              <Text variant="bodyMedium"  style={{ color: "rgb(217,75,155)", fontFamily : 'Roboto_500Medium' }} >{modalMessage}</Text>
            </Dialog.Content>
            <Dialog.Actions>
              <Button 
                onPress={hideDialog}
